...
export default function Navigation() {
  ...
  // Definir las rutas de navegación principales
  const navItems = [
    {
      path: '/dashboard',
      icon: (
  ...
  // Rutas de administración que solo verán los usuarios con rol Admin
  ...
  // Combinar las rutas normales con las de administración
